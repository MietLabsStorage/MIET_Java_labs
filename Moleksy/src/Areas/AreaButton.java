...
public class AreaButton extends RectangleArea {
    ...
    public void paintComponent(Graphics g) {
        ...
        if(component.getAtomicStat() == Stat.Atom) {
            ...
            Rectangle2D rect1 = new Rectangle2D.Double((getWidth()/2-component.getWidth())/2,(getHeight()-component.getHeight())/2,component.getWidth(),component.getHeight());
            g2.draw(rect1);
            g2.fill(rect1);
            //white-fill
        ...
        g2.setFont(name);
        g2.drawString(component.getName(), (getWidth()/2-component.getWidth())/2+getWidth()/4, (getHeight()+component.getHeight())/2);
